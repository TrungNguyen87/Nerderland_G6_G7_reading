...

{
  ...
  text: {
    nl: [
      "Een brood dat een dag oud is, een zak sla die net iets te slap is geworden, een pak yoghurt waarvan de datum gisteren verliep: elke dag verdwijnt er in Nederland een enorme berg eten in de vuilnisbak. Niet omdat het bedorven is, maar omdat iemand ergens in de keten besloot dat het niet meer verkocht, geserveerd of gegeten kon worden.",
      "Die keten begint op het land. Een deel van de oogst blijft daar gewoon liggen: te klein, te groot, of overtollig omdat de vraag op dat moment lager was dan verwacht. Verderop, in fabrieken en winkels, gaat eten weg door beschadigde verpakkingen, te volle schappen en producten die simpelweg niet op tijd verkocht raakten.",
      "In restaurants speelt iets anders mee: mensen bestellen te veel, of de keuken bereidt uit voorzorg net iets meer dan er die avond wordt opgegeten. En dan is er de laatste schakel, misschien wel de grootste: thuis. Onderzoekers schatten dat huishoudens samen minstens net zoveel weggooien als winkels en restaurants bij elkaar.",
      "Een groot deel van die thuisverspilling komt door een misverstand over de datum op de verpakking. Veel mensen lezen \"ten minste houdbaar tot\" als een harde grens: één dag erover en het pak gaat de bak in. Maar die datum zegt iets over kwaliteit, niet over veiligheid. Een pak koekjes dat een week over de datum is, is heus niet giftig; het is hooguit iets minder knapperig.",
      "Bij \"te gebruiken tot\", vooral op vlees, vis en verse maaltijden, ligt dat anders: die datum gaat wél over veiligheid, omdat bacteriën dan de kans krijgen om te groeien. Het verschil tussen die twee zinnetjes lijkt klein, maar het bepaalt of je een half pak yoghurt met een gerust hart opeet of toch maar weggooit.",
      "Wat helpt, is vooral heel gewoon gedrag. Van tevoren een boodschappenlijst maken voorkomt dat je dingen dubbel koopt. De koelkast op de juiste temperatuur zetten, ergens tussen de twee en de vier graden, houdt groente en zuivel dagen langer goed. En kliekjes de volgende dag opwarmen levert zomaar een gratis lunch op.",
      "Geen van die stappen is ingewikkeld. Toch zou Nederland, als iedereen ze toepaste, in één klap een groot deel van al dat weggegooide eten kunnen redden. Het probleem zit dus niet alleen bij boeren, fabrieken of supermarkten. Het zit voor een flink stuk gewoon in onze eigen keuken."
    ],
    en: [
      "A loaf of bread that is a day old, a bag of lettuce that has gone just a bit too limp, a carton of yoghurt whose date expired yesterday: every day an enormous pile of food disappears into the bin in the Netherlands. Not because it has gone bad, but because somewhere along the chain someone decided it could no longer be sold, served or eaten.",
      "That chain begins in the field. Part of the harvest simply stays there: too small, too big, or surplus because demand at that moment was lower than expected. Further along, in factories and shops, food is lost through damaged packaging, overstocked shelves and products that simply did not sell in time.",
      "In restaurants something else plays a role: people order too much, or the kitchen prepares slightly more than gets eaten that evening, just to be safe. And then there is the last link, perhaps the biggest one: home. Researchers estimate that households together throw away at least as much as shops and restaurants combined.",
      "A large part of that waste at home comes from a misunderstanding about the date on the packaging. Many people read \"best before\" as a hard line: one day over and the packet goes in the bin. But that date says something about quality, not about safety. A packet of biscuits a week past its date is really not poisonous; at most it is a little less crunchy.",
      "With \"use by\", mainly on meat, fish and fresh meals, that is different: that date really is about safety, because bacteria get the chance to grow after it. The difference between those two little phrases seems small, but it decides whether you eat half a tub of yoghurt with an easy mind or throw it away after all.",
      "What helps is mostly very ordinary behaviour. Making a shopping list beforehand stops you buying things twice. Setting the fridge to the right temperature, somewhere between two and four degrees, keeps vegetables and dairy good for days longer. And reheating leftovers the next day gives you a free lunch out of nowhere.",
      "None of those steps is complicated. Yet if everyone in the Netherlands applied them, the country could save a large part of all that wasted food in one go. So the problem does not only lie with farmers, factories or supermarkets. A good part of it simply lies in our own kitchen."
    ]
  },
  words: [
